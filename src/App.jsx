...
import SessionExpirationManager from "./components/auth/SessionExpirationManager.jsx"; // Importa o novo componente
...
function App() {
  return (
    <AuthProvider>
      {/* O Gestor de Sessão é colocado aqui para monitorizar a aplicação inteira */}
